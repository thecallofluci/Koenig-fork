...
const InitialContentToggle = ({defaultContent, setTitle, searchParams, setSearchParams}) => {
    ...
    return (
        <>
            <button className="absolute right-6 top-4 z-20 block h-[22px] w-[42px] cursor-pointer rounded-full bg-luci transition-all ease-in-out" type="button" onClick={toggle}>
